...
last_name_len = len(player[player.find(" "):] [:-1]) # = Vraag 3: len + find + slicen

name_short = player[0:1] + '.' + ' ' +  player[player.find(" ")+1:] # = Vraag 4

chant = (F'{first_name}! '* 5) [:-1] # = Vraag 5

#chant = ((first_name + '!' + ' ') * 5) [:-1] # = Vraag 5 --> LET OP!!! Op deze manier is het ook mogelijk.
...
print('\n')
print(last_name_len) # Part 2: vraag 3
print('\n')
